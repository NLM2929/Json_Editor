...
-I"D:/NLM/C++_Libraries/json-develop/include" -I"D:/NLM/C++_Libraries/raygui-master/src" \
...
ifeq ($(PLATFORM),PLATFORM_DESKTOP)
    ...
    ifeq ($(PLATFORM_OS),LINUX)
        ...
        LDLIBS = -lraylib_modified -lGL -lm -lpthread -ldl -lrt
    ...
    ifeq ($(PLATFORM_OS),OSX)
        ...
        LDLIBS = -lraylib_modified -framework OpenGL -framework OpenAL -framework Cocoa -framework IOKit
    endif
    ifeq ($(PLATFORM_OS),BSD)
        # Libraries for FreeBSD, OpenBSD, NetBSD, DragonFly desktop compiling
        # NOTE: Required packages: mesa-libs
        LDLIBS = -lraylib_modified -lGL -lpthread -lm
...
ifeq ($(PLATFORM),PLATFORM_RPI)
    ...
    LDLIBS = -lraylib_modified -lbrcmGLESv2 -lbrcmEGL -lpthread -lrt -lm -lbcm_host -ldl
endif
ifeq ($(PLATFORM),PLATFORM_WEB)
...
# SRC := $(call rwildcard, ./, *.cpp) $(call rwildcard, ./, *.c)
...
# 	$(CC) -o main_test.exe main_test.cpp $(CFLAGS) $(INCLUDE_PATHS) $(LDFLAGS) $(LDLIBS) -D$(PLATFORM)
